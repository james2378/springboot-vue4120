	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="婚姻" prop="hunyin">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="婚姻" prop="hunyin">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-if="type!='info'&& !ro.danganwenjian" label="档案文件" prop="danganwenjian">
					<file-upload
						tip="点击上传档案文件"
						action="file/upload"
						:limit="1"
