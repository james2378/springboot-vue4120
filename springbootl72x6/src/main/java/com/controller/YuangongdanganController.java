...
public class YuangongdanganController {
    ...
    public R page(@RequestParam Map<String, Object> params,YuangongdanganEntity yuangongdangan,
		...
		if(tableName.equals("yuangong")) {
			yuangongdangan.setGonghao((String)request.getSession().getAttribute("username"));
		}
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<YuangongdanganEntity> wrapper = new EntityWrapper<YuangongdanganEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = yuangongdanganService.selectCount(wrapper);
